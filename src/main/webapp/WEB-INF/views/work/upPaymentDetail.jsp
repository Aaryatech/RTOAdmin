				...
				<div class="col-md-12">
					...
					<div class="card">
						<div class="card-header">
							<strong class="card-title">Update Payment Detail</strong>
						</div>
						<div class="card-body card-block">

							<form
								action="${pageContext.request.contextPath}/updateDetailPaymentAndStatus"
								method="post">
										...
										<div>
											...
											<div class="input-group" style="align-items: center;">
												Remaining Payment &nbsp; <input class="form-control"
													id="exInt2" name="exInt2" value="${getWork.exInt2}"
